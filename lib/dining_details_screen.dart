...
import 'services /models.dart'; // Ensure you're importing the correct file where DiningLocation is defined
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          Text('Menu:'),
          ...location.menu.map((item) => Text(item)).toList(), // Access 'menu' here
        ],
      ),
    );
  }
